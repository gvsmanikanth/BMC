...
var configuration = {
	...
	tasks: [
		
		{
			...
			autoClean: true,
			autoCleanPaths: ['./*.css'],
			assetPathKey: 'allianceProgram',
			output: allianceProgramRoot + '/assets'
		},
		{
			driver: 'js',
			paths: ['./js/**/*.js'],
		...
		{
			paths: ['./templates/ui-guide.php', './templates/contact-us-generic-form.php', './templates/contact-us-generic-form-thanks.php'],
			base: './templates',
		...
		{
			driver: 'php-inc-allianceProgram',
