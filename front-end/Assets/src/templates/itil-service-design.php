		...
		<article class="layout-primary">
			...
			<section>
				...
				<ul>
					...
					<li>monitoring, measuring and reporting on how well the service provider delivered the agreed upon targets&nbsp;</li>
				</ul>
				<p>When targets are appropriate and met, then the business and IT have a better chance of becoming aligned.&nbsp;</p>
				<p>Agreed upon targets are often&nbsp;spelled out in service level agreements (SLAs). Monitoring, measuring and reporting on SLA's in this way provides close links to Continual Service Improvement (CSI).&nbsp;</p>
				<p>SLAs are agreements to provide specific services at a defined level of quality (warranty) for a specific price. SLAs typically need negotiation of&nbsp;agreements with other internal organizations (OLA's) or external&nbsp;suppliers (Underpinning Contracts).&nbsp;</p>
				<p>Negotiating SLAs to ensure service commitments are met, service level management works&nbsp;with the following warranty processes:</p>
				<ul>
			...
			<section>
				...
				<p>Service catalog management ensures that an accurate and up-to-date service catalog is&nbsp;available to all parties authorized to see it. All parts of IT Service Management, as well as&nbsp;customers and users, use the service catalog.&nbsp;Accuracy and availability are essential.</p>
				<p>Service catalog management must work closely with service portfolio management as new services move from the pipeline into the catalog and older services are retired. It also helps define how services can be&nbsp;requested&nbsp;and what options are available (gold/silver levels, for instance). The service catalog should document all defined services.&nbsp;</p>
				<p>The service catalog generally comprises two views:&nbsp;</p>
				<ul>
					<li>a business service view that is visible to the customer&nbsp;</li>
			...
			<section>
				<h2>
					<a name="availability"></a>Availability Management
				</h2>
				<p>Availability Management ensures&nbsp;that&nbsp;infrastructure,&nbsp;tools, roles etc. are appropriate for the agreed&nbsp;targets.&nbsp;It also works with the design teams to ensure that availability is designed into services.</p>
				<p>Part of the process is to identify vital business functions (VBFs) which IT services support. This will help clarify which approach to availability to take:&nbsp;</p>
				<ul>
					<li>prevention (making sure, as far as possible, that unavailability never happens)&nbsp;</li>
					<li>recovery (developing plans to restore service rapidly in the event of an outage).</li>
				</ul>
				<p>Availability management views availability from the user&rsquo;s perspective, from end to end. This means identifying single points of failure and designing resilience into any&nbsp;infrastructure supporting the service. Availability management serves as a focal point for all issues in IT Service Management related to availability.&nbsp;</p>
				<p>Availability management handles specifying which metrics to&nbsp;use&nbsp;to measure availability. And,&nbsp;monitors availability to ensure that the SLA targets are met.</p>
			</section>
			<section>
				<h2>
					<a name="continuity"></a>IT Service Continuity Management
				</h2>
				<p>IT service continuity management (ITSCM) focuses on supporting the overall&nbsp;continuity of the business. We define ITSCM as the process responsible for managing risks that could seriously impact IT services.&nbsp;</p>
				<p>Risks so serious&nbsp;they&nbsp;could&nbsp;threaten the very survival of the business.</p>
				<p>This activity is often referred to as disaster recovery (DR).&nbsp;But, the use of the term ITSCM should show that there is a corresponding business continuity management (BCM) process.&nbsp;ITSCM&nbsp;supports the BCM process.</p>
				<p>ITSCM must work closely with BCM to perform risk analysis and&nbsp;business impact analysis (BIA). This analysis determines how different types of disruptions impact the business. The business areas determined to suffer the greatest impact&nbsp;need the most focus from&nbsp;the service continuity teams.</p>
				<p>ITSCM is responsible for development and deployment of the service continuity plan.&nbsp;This includes regular testing and&nbsp;training of all personnel&nbsp;associated with the plan.&nbsp;ITSCM also works with change management to ensure that continuity plans are&nbsp;updated&nbsp;as the operational model changes.</p>
				<p>
					There are four stages in the ITSCM lifecycle process:<br />1. Initiation<br />2. Requirements and strategy<br />3. Implementation<br />4. Ongoing operation
				</p>
				<p>
					<img src="http://media.cms.bmc.com/images/itscm-lifecycle-diagram.jpg" alt="itscm+lifecycle+diagram" width="1038" height="282" />
				</p>
				<p>&nbsp;</p>
			</section>
			<section>
				<h2>ITIL Information Security Management</h2>
				<a class="btn" href="/guides/itil-information-security-management.html">ITIL Information Security Management Processes &amp; Best Practices &rsaquo;</a>
			</section>
			<section>
				<h2>
					<a name="supplier"></a>Supplier Management
				</h2>
				<p>Supplier management works with third parties, such as&nbsp;suppliers,&nbsp;to negotiate contracts for products or services.&nbsp;&nbsp;Supplier management&nbsp;monitor conformance to the contract conditions and address any breaches. At renewal, supplier management will determine whether to renew, renegotiate, or end the contract.</p>
				<p>The objectives of supplier management is&nbsp;to ensure alignment of&nbsp;contracts&nbsp;with the needs of the business. It is also responsible for ensuring&nbsp;suppliers are meeting their commitments.&nbsp;The supplier and contract management information system (SCMIS) holds&nbsp;supplier and contract details.&nbsp;</p>
			</section>
			<section>
				<h2>
					<a name="design"></a>Design Coordination
				</h2>
				<p>The central principles in design coordination are balance,&nbsp;prioritization&nbsp;and integration with project management. Balance and prioritization address the utility and warranty of a service, as well as the needs of the service throughout its lifecycle.&nbsp;</p>
				<p>Design coordination oversees all activity in the Service Design phase of the service lifecycle. Its aim is to ensure that a holistic, integrated approach is taken to the design of services. This is necessary because of the variety of disciplines involved in Service Design and the need to take a consistent approach.</p>
				<p>Design coordination is accountable for the production of the service design package (SDP).&nbsp;The SDP&nbsp;is a comprehensive description of how a new or changed service is to be designed, built, tested, deployed, and operated. The SDP is the handoff from the Service Design phase to the Service Transition phase.</p>
				<p>Design coordination handles managing&nbsp;resources needed by the Service Design phase of the lifecycle. This includes:&nbsp;</p>
				<ul>
					<li>planning to ensure that adequate resources are available&nbsp;</li>
					<li>scheduling access to resources among the many projects that may be in this phase at any one time</li>
				</ul>
				<p>It is accountable for the&nbsp;performance and improvement of the Service Design phase of the lifecycle.</p>
			</section>
			<figure>
...
// ]]></script -->
			<section class="lower-nav">
				...
				<div class="itil-introduction-nav" data-showon="itil-introduction">
					<a href="/guides/itil-service-strategy.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Service Strategy</div>
						</div>
					</a>
				</div>
				...
				<div class="itil-capacity-management-nav" data-showon="itil-capacity-management">
					<a href="/guides/itil-information-security-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: Information Security Management</div>
						</div>
					</a>
				</div>
				<div class="itil-information-security-management-nav" data-showon="itil-information-security-management">
					<a href="/guides/itil-service-transition.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Service Transition</div>
						</div>
					</a>
				</div>
				<div class="itil-service-transition-nav" data-showon="itil-service-transition">
					<a href="/guides/itil-change-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Change Management</div>
						</div>
					</a>
				</div>
				<div class="itil-change-management-nav" data-showon="itil-change-management">
					<a href="/guides/itil-release-deployment-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: Release & Deployment Management</div>
						</div>
					</a>
				</div>
				<div class="itil-release-deployment-management-nav" data-showon="itil-release-deployment-management">
					<a href="/guides/itil-asset-configuration-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: Asset & Configuration Management</div>
						</div>
					</a>
				</div>
				<div class="itil-asset-configuration-management-nav" data-showon="itil-asset-configuration-management">
					<a href="/guides/itil-knowledge-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Knowledge Management</div>
						</div>
					</a>
				</div>
				<div class="itil-knowledge-management-nav" data-showon="itil-knowledge-management">
					<a href="/guides/itil-service-operation.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Service Operation</div>
						</div>
					</a>
				</div>
				<div class="itil-service-operation-nav" data-showon="itil-service-operation">
					<a href="/guides/itil-incident-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Incident Management</div>
						</div>
					</a>
				</div>
				<div class="itil-incident-management-nav" data-showon="itil-incident-management">
					<a href="/guides/itil-service-request-fulfillment.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Service Request Fulfillment</div>
						</div>
					</a>
				</div>
				<div class="itil-service-request-fulfillment-nav" data-showon="itil-service-request-fulfillment">
					<a href="/guides/itil-event-management.html">
						<div id="arrow4" class="arrow">
							<div class="red">Next: ITIL Event Management</div>
						</div>
					</a>
				</div>
		...
		<aside class="layout-secondary">
			<section class="float-rail-nav-container">
				...
				<ol class="float-rail-nav  ol ">
					<li><a class="learn-more" href="/guides/itil-introduction.html" target="_self">ITIL Processes & Best Practices Introduction</a></li>
					<li><a class="learn-more" href="/guides/itil-service-strategy.html" target="_self">ITIL Service Strategy</a></li>
					<li><a class="learn-more" href="/guides/itil-demand-management.html" target="_self">ITIL Demand Management</a></li>
					<li class="current"><a class="current learn-more" href="/guides/itil-service-design.html" target="_self">ITIL Service Design</a></li>
					<li><a class="learn-more" href="/guides/itil-capacity-management.html" target="_self">ITIL Capacity Management</a></li>
					<li><a class="learn-more" href="/guides/itil-information-security-management.html" target="_self">ITIL Information Security Management</a></li>
					<li><a class="learn-more" href="/guides/itil-service-transition.html" target="_self">ITIL Service Transition</a></li>
					<li><a class="learn-more" href="/guides/itil-change-management.html" target="_self">ITIL Change Management</a></li>
					<li><a class="learn-more" href="/guides/itil-release-deployment-management.html" target="_self">ITIL Release and Deployment Management</a></li>
					<li><a class="learn-more" href="/guides/itil-asset-configuration-management.html" target="_self">ITIL Asset and Configuration Management</a></li>
					<li><a class="learn-more" href="/guides/itil-knowledge-management.html" target="_self">ITIL Knowledge Management</a></li>
					<li><a class="learn-more" href="/guides/itil-service-operation.html" target="_self">ITIL Service Operation</a></li>
					<li><a class="learn-more" href="/guides/itil-incident-management.html" target="_self">ITIL Incident Management</a></li>
					<li><a class="learn-more" href="/guides/itil-service-request-fulfillment.html" target="_self">ITIL Service Request Fulfillment</a></li>
					<li><a class="learn-more" href="/guides/itil-event-management.html" target="_self">ITIL Event Management</a></li>
					<li><a class="learn-more" href="/guides/itil-access-management.html" target="_self">ITIL Access Management</a></li>
					<li><a class="learn-more" href="/guides/itil-problem-management.html" target="_self">ITIL Problem Management</a></li>
