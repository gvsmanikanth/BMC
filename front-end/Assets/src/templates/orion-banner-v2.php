...
<section class="bg-white anchor-banner-wrap orion-global orion-anchor-banner blob-animate">
    <div class="sp-large-container anchor-banner-back-blob blob-small rellax" data-rellax-speed="3" style='background-image: url("Assets/src/img/orion/simplebanner-variation-2-cyan.svg");'  >
		
		<div class="anchor-banner blob-large rellax" data-rellax-speed="-3" style='background-image: url("Assets/src/img/orion/simplebanner-variation-2-blue.svg");'  >			
