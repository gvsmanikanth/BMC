<?php
	$pageTitle = 'orion-anchor-banner-new-v2';
...
<section class="bg-white orion-global orion-banner anchor-banner resources-banner">
    <div class="sp-large-container">        
        ...
        <div class="blob-container">        
            <div class=" blob-hidden " style='background-image: url("Assets/src/img/orion/anchorbanner-variation-2-cyan.svg");' >		
                       
            </div>
            <div class="blob-masked" style='background-image: url("Assets/src/img/orion/anchorbanner-variation-2-orange.svg");'  >
            </div> 
        </div>
    </div>	
