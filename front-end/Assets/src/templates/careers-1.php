...
<div id="page-content" class="careers_overview bg-white">
	...
	<section id="work-for-bmc" class="section bg-white culture-com">
		...
		<!-- <div class="section-content-full text-center md-text-left">
			<div class="owl-carousel owl-responsive owl-theme--orange">
				<a href="/templates/Media_Video_Mobile?vID=8635030831d3d" target="_self" class="card flex-col video-play modal-video-player" onclick="s_objectID=&quot;http://www.bmc.com/templates/Media_Video_Mobile?vID=8635030831d3d_1&quot;;return this.s_oc?this.s_oc(e):true">
					<div class="ha card-image mb2">
						<img src="includes/2016/careers/thumbs/fast-track.jpg">
						<svg class="icon--playButton pos-center">
							<use xlink:href="#s-VideoPlay" />
						</svg>
					</div>
					<div class="card-content xs-max-hide">
						<div class="h4 ship-gray">Fast Track Digital Business</div>
					</div>
				</a>
				<a href="/templates/Media_Video_Mobile?vID=0ed0e1e79aeeb" class="card flex-col modal-video-player">
					<div class="ha card-image mb2">
						<img src="includes/2016/careers/thumbs/it-transforms.jpg">
						<svg class="icon--playButton pos-center">
							<use xlink:href="#s-VideoPlay" />
						</svg>
					</div>
					<div class="card-content xs-max-hide">
						<div class="h4 ship-gray">Bring IT to Life with Digital Enterprise Management</div>
					</div>
				</a>
				<a href="/templates/Media_Video_Mobile?vID=0ed0e1e79aeeb" class="card flex-col modal-video-player">
					<div class="ha card-image mb2">
						<img src="//media.cms.bmc.com/designimages/careers-thumbs-brings-dem.jpg">
						<svg class="icon--playButton pos-center">
							<use xlink:href="#s-VideoPlay" />
						</svg>
					</div>
					<div class="card-content xs-max-hide">
						<div class="h4 ship-gray">Brings Digital Enterprise Management to Life</div>
					</div>
				</a>
			</div>
		</div> -->
