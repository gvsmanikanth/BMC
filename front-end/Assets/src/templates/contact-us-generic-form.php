		...
		<div class="layout-inner-wrap">
			<div class="layout-content">
				<section>
					<figure></figure>
					<p>
						Thank you for your interest in BMC Solutions. Please provide your contact details and area of interest and someone will get back to you <b>as soon as possible.</b>
					</p>
					<p>Whether you're in the early stages of product research, evaluating competitive solutions, or just trying to scope your needs to begin a project, we're happy to help you get the information you need to move forward with your IT initiatives.</p>
				</section>
				<section class="feature-message">
					<div class="layout-inner-wrap">
						<h2 class="section-header" style="text-align: center;">
							BMC digital IT powers <span>82%</span> of <span>Fortune 500</span> companies
						</h2>
						<ul class="brands">
							<li class="fortune-500-carfax">Carfax</li>
							<li class="fortune-500-ingram">Ingram</li>
							<li class="fortune-500-google">Google</li>
							<li class="fortune-500-amazon">Amazon</li>
							<li class="fortune-500-oracle">Lockheed Martin</li>
							<li class="fortune-500-boeing">Southern Company</li>
							<li class="fortune-500-citi">Citi</li>
							<li class="fortune-500-ford">Ford</li>
							<li class="fortune-500-eaton">Eaton</li>
						</ul>
					</div>
				</section>
			</div>
			<div class="layout-form">
				<p>
					<strong> Please complete this form for a call back. </strong>
				</p>
				<form id="new_form" name="new_form" method="POST" action="/content/bmc/language-masters/en/forms/demo-form-landingpage/_jcr_content/root/maincontentcontainer/section_layout_1262318817/form.post.html" enctype="multipart/form-data" class="aem-Grid aem-Grid--12 aem-Grid--default--12  customerform" novalidate="novalidate">
					<input name="wcmmode" value="disabled" type="hidden" /> <span style="display: none;"><input type="text" name="Address3" id="Address3" /><input type="text" name="Surname" id="Surname" /></span>
							...
							<div class="field-set responsivegrid aem-GridColumn aem-GridColumn--default--12">
								<fieldset class="aem-Grid aem-Grid--12 aem-Grid--default--12 aem-Grid--phone--12  ">
									<div class="cmp cmp-form-field aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--6">
										<input aria-label="First Name" type="text" id="form-text-1911456302" placeholder="First Name" name="C_FirstName" />
									</div>
									<div class="cmp cmp-form-field aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--6">
										<input aria-label="Last Name" type="text" id="form-text-1328081140" placeholder="Last Name" name="C_LastName" />
									</div>
									<div class="cmp cmp-form-field aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--12">
										<input aria-label="Business Email" type="email" id="form-text-684382369" placeholder="Business Email" name="C_EmailAddress" />
									</div>
									<div class="cmp cmp-form-field aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--12">
										<input aria-label="Company" type="text" id="form-text-448657761" placeholder="Company" name="C_Company" />
									</div>
									<div class="cmp cmp-form-field aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--6">
									...
									<div class="cmp cmp-options aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--6">
										<select name="C_Job_Level1" id="form-options-1563715082" class="form-control countrySelector">
											<option selected disabled>Country</option>
											<option value="AF" data-gdpr="true">Afghanistan</option>
											<option value="AL">Albania</option>
											<option value="DZ">Algeria</option>
											<option value="AS">American Samoa</option>
											<option value="AD">Andorra</option>
									...
									<div class="cmp cmp-options aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--6">
										<select name="C_Product_Interest1" id="form-options-1615030451" class="form-control" >
											...
											<option value="APM">BMC Application Release Manager</option>
											<option value="SaaS AppZone">BMC AppZone</option>
											<option value="Discovery">BMC Atrium</option>
											<option value="BDA">BMC Bladelogic Automation Suite</option>
											<option value="BDA">BMC BladeLogic Database Automation</option>
											<option value="BMA">BMC BladeLogic Middleware Automation</option>
											<option value="BNA">BMC Bladelogic Network Automation</option>
											<option value="BSA">BMC BladeLogic Server Automation</option>
											<option value="TrueSight Capacity">BMC Capacity Optimizer</option>
											<option value="BCM">BMC Client Management (Asset Core)</option>
											<option value="CLM">BMC Cloud Lifecycle Management</option>
											<option value="CLM">BMC Cloud Operations Management</option>
											...
											<option value="SaaS Marketplace">BMC Marketplace</option>
											...
											<option value="Remedy">BMC Service Management</option>
											<option value="Track-It!">BMC Track-IT!</option>
											<option value="SaaS TrueSight Intelligence">BMC TrueSight</option>
											<option value="TrueSight Capacity">BMC TrueSight Capacity</option>
										</select>
									</div>
									<div class="cmp cmp-options aem-GridColumn aem-GridColumn--default--12">
										<div class="form-group checkbox">
											<ol id="C_Checkbox">
												...
												<li id="C_OptIn_group"><input type="checkbox" name="C_Checkbox" id="C_Checkbox" value="yes" /> <label for="C_Checkbox"> I would like to receieve marketing communications regarding BMC products,services and events. I can unsubscribe at a later time. </label></li>
											</ol>
										</div>
									</div>
									<div class="cmp cmp-options aem-GridColumn aem-GridColumn--default--12">
									...
									<div class="visible aem-GridColumn aem-GridColumn--default--12">
										<input type="hidden" name="elqFormName" value="FormTemplate1_DXPTesting" />
									</div>
									<div class="visible aem-GridColumn aem-GridColumn--default--12">
