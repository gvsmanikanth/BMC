...
<div id="backgroundImage" style="background-size: cover;background-repeat:repeat-y;background-position:center center;">
  ...
  <section class="section-wrap-header sectionCommon" id="section0"  style="min-height:860px;background-color:#414042; background: url(/content/dam/bmc/home/End_Frame_HORIZONTAL_FLIP_retouch_logo.jpg) no-repeat center center;background-size: cover;">
	<div class="section video-hero-header" >
	   <div class="video-content" >
		      <div class="hero-image xs-only"></div>
		      <div class="hero-image video xs-max-hide">
				 <div class="vidbg-box" data-vidbg-bg="mp4:/content/dam/bmc/home/BMC_Looped_Marquee_FINAL_041218.mp4" data-vidbg-options="loop: false, muted: true, overlay: false, overlayColor: #000, overlayAlpha: 0"></div>
		      </div>
		      ...
		      <div class="section-wrap-header flex flex-center layout-inner-wrap hero-content white text-left transparent-bg py4" >
		      	<div class="flex-item m2 header-content-box" id="header-content-box-id" style="visibility: hidden">
			         ...
			         <a href="/content/bmc/videos.html?vID=z_pA5yH8YwA" class="modal-youtube-video-player btn btn-corporate" title="Transforming the Digital Enterprise"> 
      ...
      <div class="flex-item section-content py4 layout-inner-wrap"> 
         <div class="md-flex flex flex-center full-bleed-two-column">
            ...
            <div class="flex-item col col-12 xs-col-6 text-center" data-aos-once="true" data-aos="fade-left">
				<img class="mobile-only" data-src="/content/dam/bmc/home/preview.png" alt="Multi Cloud Animation">
               <figure class="desktop-only">
				<object id="EdgeID1" type="text/html" width="100%" height="100%" data-dw-widget="Edge" data="/content/dam/bmc/edgeanim/multi-cloud-anim/multi_cloud_animation_4.html">
				</object>
                </figure> 
      ...
      <div class="flex-item section-content py4 layout-inner-wrap">
         <div class="md-flex flex flex-center full-bleed-two-column">
            <div class="flex-center flex-item col col-12 xs-col-6 pxr1 text-center" data-aos-once="true"  data-aos="fade-right">
				<img class="mobile-only" data-src="/content/dam/bmc/home/migration.png" alt="Migration Animation">
				<figure class="desktop-only">
            ...
            <div class="flex-item col col-12 xs-col-6" >
               ...
               <a href="/it-solutions/multi-cloud-migration.html" data-aos-once="true" data-aos="fade-left" data-aos-anchor-placement="center-bottom" data-aos-delay='400' class="learn-more">Learn more about multi-cloud migration</a>
            </div>
         </div>
      </div>
   </section>
      ...
      <div class="flex-item section-content py4 layout-inner-wrap">
         <div class="md-flex flex flex-center full-bleed-two-column">
            <div class="flex-item col col-12 xs-col-6 pxr1">
               ...
               <a href="/it-solutions/cloud-cost-control.html" data-aos-once="true" data-aos="fade-right" data-aos-anchor-placement="center-bottom" data-aos-delay='400' class="learn-more">Learn more about multi-cloud cost</a>
            </div>
            <div class="flex-item col col-12 xs-col-6 text-center" data-aos-once="true" data-aos="fade-left">
			   ...
			   <div class="carousel-wrap">
					<ul class="carousel">
						<li data-slide="0" class="active">
							<figure>
								<img data-src="/content/dam/bmc/home/cost.png" alt="Cost" title="" width="900" border="0" height="516">		
							</figure>
						</li>
					</ul>
				</div>
      ...
      <div class=" flex-item section-content py4 layout-inner-wrap">
         <div class="md-flex flex flex-center full-bleed-two-column">
               ...
               <!--<img data-src="//www.bmc.com/content/dam/bmc/home/service-man.png" alt="Mobile phone and app infographic">-->
			    <div class="carousel-wrap">
					<ul class="carousel">
						<li data-slide="0" class="active">
							<figure>
								<img data-src="/content/dam/bmc/home/Service Managment.png" alt="Multi Cloud Service Management" title="" width="900" border="0" height="516">		
							</figure>
						</li>
					</ul>
				</div>
            ...
            <div class="flex-item col col-12 xs-col-6" >
               ...
               <a href="/it-solutions/multi-cloud-service-management.html" data-aos-once="true" data-aos="fade-left" data-aos-anchor-placement="center-bottom" data-aos-delay='400' class="learn-more">Learn more about multi-cloud service management</a>
            </div>
         </div>
      </div>
   </section>
      ...
      <div class=" flex-item section-content py4 layout-inner-wrap">
         <div class="md-flex flex flex-center full-bleed-two-column">
            <div class="flex-item col col-12 xs-col-6 pxr1">
               ...
               <a href="/it-solutions/discovery-dependency-mapping.html" data-aos-once="true" data-aos="fade-right" data-aos-anchor-placement="center-bottom" data-aos-delay='400' class="learn-more">Learn more about multi cloud visibility</a>
            </div>
			<div class="flex-item col col-12 xs-col-6 text-center" data-aos-once="true" data-aos="fade-left">
               <!--<img data-src="//www.bmc.com/content/dam/bmc/home/Visibility.png" alt="Mobile phone and app infographic">-->
			    <div class="carousel-wrap">
					<ul class="carousel">
						<li data-slide="0" class="active">
							<figure>
								<img data-src="/content/dam/bmc/home/Visibility.png" alt="Multi Cloud Visibility" title="" width="900" border="0" height="516">		
							</figure>
						</li>
					</ul>
				</div>
   ...
   <section class="flex flex-center section-wrap section2 sectionCommon" id="section6">
      <div class=" flex-item section-content py4 layout-inner-wrap">
         <div class="md-flex flex flex-center full-bleed-two-column">
			<div class="flex-item col col-12 xs-col-6 pxr1 text-center" data-aos-once="true" data-aos="fade-right">
				<img class="mobile-only" data-src="/content/dam/bmc/home/performance.png" alt="Multi Cloud Performance">
				<figure class="desktop-only">
            ...
            <div class="flex-item col col-12 xs-col-6">
               ...
               <a href="/it-solutions/truesight-multi-cloud-operations.html" data-aos-once="true" data-aos="fade-left" data-aos-anchor-placement="center-bottom" data-aos-delay='400' class="learn-more">Learn about cloud performance monitoring</a>
            </div>
      ...
      <div class=" flex-item section-content py4 layout-inner-wrap">
         <div class="md-flex flex flex-center full-bleed-two-column">
            <div class="flex-item col col-12 xs-col-6 pxr1 ">
               ...
               <a href="/it-solutions/control-m.html"  data-aos-once="true" data-aos="fade-right" data-aos-anchor-placement="center-bottom" data-aos-delay='400' class="learn-more">Learn more about multi-cloud automation</a>
            </div>
			<div class="flex-item col col-12 xs-col-6 text-center" data-aos-once="true" data-aos="fade-left">
			...
			<div class="carousel-wrap">
				<ul class="carousel">
					<li data-slide="0" class="active">
						<figure>
							<img data-src="/content/dam/bmc/home/automation.png" alt="Multi Cloud Automation" title="" width="900" border="0" height="516">		
						</figure>
					</li>
				</ul>
			</div>
         ...
         <div class="md-flex flex flex-center full-bleed-two-column">
			...
			<div class="carousel-wrap">
				<ul class="carousel">
					<li data-slide="0" class="active">
						<figure>
							<img data-src="/content/dam/bmc/home/Security.png" alt="Multi Cloud Security" title="" width="900" border="0" height="516">		
						</figure>
					</li>
				</ul>
			</div>
            ...
            <div class="flex-item col col-12 xs-col-6 pxr1">
               ...
               <a href="/it-solutions/secops-policy-service.html" data-aos-once="true" data-aos="fade-left" data-aos-anchor-placement="center-bottom" data-aos-delay='400'  class="learn-more">Learn more about multi-cloud security</a>
            </div>
         </div>
      </div>
   </section>
    ...
    <div class="partners sectionCommon section-wrap" id="section9"> 
        <div class="container" data-aos-once="true" data-aos="zoom-in">
            <div class="partners_sec">
                ...
                <ul>
                    <li><img data-src="/content/dam/bmc/home/logoimg2.png" alt="Amazon Partner Neetwork"></li>
                    <li><img data-src="/content/dam/bmc/home/Microsoft_Azure.svg" alt="Azure"></li>
                    <li><img data-src="/content/dam/bmc/home/logoimg3.svg" alt="Google Cloud Platform"></li>
                </ul>
            </div>
        </div>
    </div>
   ...
   <ul class="xs-max-hide">
	...
	<div class="Customer" >
            ...
            <div class="layout-inner-wrap py2">
               <div class="md-flex flex flex-center full-bleed-two-column">
					...
					<div class="flex-item col col-12 xs-col-6 pxr1 text-center" >
						<div class="carousel-wrap">
							<figure>
								<img class="block1" data-src="/content/dam/bmc/home/benefits.png" alt="Benefits" >
							</figure>
						</div>
					</div>
				</div>
        ...
        <div class="logos_sec">
            <div class="container">
                <div class="logos_blk">
                    <ul>
                       <li class="imgDesp"><a class="video-play modal-youtube-video-player" href="/content/bmc/videos.html?vID=MCeJtBl2dQ4" target="_self"><img data-src="/content/dam/bmc/home/logo-barryc.png" alt="Barry"></a></li>
                        <li class="imgDesp"><a class="video-play modal-youtube-video-player" href="/content/bmc/videos.html?vID=yq9g0S50w58" target="_self"><img data-src="/content/dam/bmc/home/logo-sap.png" alt="SAP"></a></li>
                        <li class="imgDesp small"><a class="video-play modal-youtube-video-player" href="/content/bmc/videos.html?vID=MBpzcyqsw-Y" target="_self"><img data-src="/content/dam/bmc/home/logoimg7.png" alt="O2"></a></li>
                        <li class="imgDesp"><a class="video-play modal-youtube-video-player" href="/content/bmc/videos.html?vID=-THadSaX-ro" target="_self"><img data-src="/content/dam/bmc/home/logo-itau.png" alt="Itau"></a></li>
                        <li class="imgDesp"><a class="video-play modal-youtube-video-player" href="/content/bmc/videos.html?vID=tJWqF2equog" target="_self"><img data-src="/content/dam/bmc/home/logo-dish.png" alt="DISA"></a></li> 
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="contact-us-large ">
		<div class="contact-us_blk layout-inner-wrap">
			 ...
			 <a data-aos-once="true" data-aos="zoom-out" type="button" class="btn-lg learn-more" href="/forms/ESM_ContactCenter_ContactRequest_BMCcom_EN_Jan2014.html">Connect with BMC</a>
        </div>
    </div>
</div>
...
function load_image()
{
    ...
    // load the image
    preloadImage.src = '/content/dam/bmc/home/End_Frame_HORIZONTAL_FLIP_retouch_logo_1.jpg';
    document.getElementById("section0").height = document.documentElement.clientHeight;
}
...
function load_backgrundImage() {
    ...
    backgroundImage.src = '/content/dam/bmc/home/mainbannerimg.jpeg';


	var bottomBannerImg = new Image();
	bottomBannerImg.onload = bottomBannerImgLoaded;
	bottomBannerImg.src = '/content/dam/bmc/home/bagroundimg.jpg';
