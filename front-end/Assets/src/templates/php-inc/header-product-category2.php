<!-- First -->
<section
	class="wallpapered bar full-bleed-page-banner product-category-header product-category-header2 padding-bottom-0 banner-image-from-top"
	data-wallpaper-options='{"source":{"fallback": "//www.bmc.com/content/dam/bmc/images/NewBrandImage-MobileBanner-Test-700x700px.png","(min-width: 640px)": "//www.bmc.com/content/dam/bmc/solutions/banners/tbn-dsm-mc-helix-service.png"}}'>
		...
		<div class="inner">
			<div class="bannerContent">
				<div class="layout-inner-wrap">
					...
					<h2>Lorem ipsum dolor sit amet, consectetur adipiscin Aliquam felis sapien, ornare condimentum -<br>Content Top-110px & Background Image from Vertical top</h2>
		...
		<div class="inner">
			<div class="bannerContent">
				<div class="layout-inner-wrap">
					...
					<h1 class="white">Lorem ipsum dolor sit</h1>
					<h2>Lorem ipsum dolor sit amet, consectetur adipiscin Aliquam felis sapien, ornare condimentum <br> Content Top-140px & Background Image from Vertical Center</h2>
					<div class="button-wrapper">
<!-- 							 ❭  -->
					</div>
					</div>
		...
		<div class="inner">
			<div class="bannerContent">
				<div class="layout-inner-wrap">
					...
					<h2>Lorem ipsum dolor sit amet, consectetur adipiscin Aliquam felis sapien, ornare condimentum - Top-82px</h2>
					<div class="button-wrapper">
						<a class="btn-secondary learn-more mr1"
							href="http://www.bmc.com/forms/control-m-enterprise-free-trial-runaware.html">CTA Example</a>
						<a class="btn-secondary btn_secondary_new btn video-play modal-youtube-video-player"
	...
	<div class="offset-wrapper flex-center js-content-center-item">
		<div class="inner">
			<div class="bannerContent flex-center">
				<div class="layout-inner-wrap">
					<div class="flex-item col col-12 md-col-6 sm-col-8 no-top-margin">
					<h1 class="white">About BMC</h1>
					<h2>Master modern IT with software, solutions, and services to help you run your business as you reinvent it<br> ( Content -> Center & BG -> Center Center )</h2>
					</div>
				</div>
			</div>
			<div class="assetStrip">
...
<!-- Fourth -->
<section
	class="wallpapered bar full-bleed-page-banner product-category-header product-category-header2 padding-bottom-0 banner-image-from-top js-content-center"
	data-wallpaper-options='{"source":{"fallback": "//www.bmc.com/content/dam/bmc/images/NewBrandImage-MobileBanner-Test-700x700px.png","(min-width: 640px)": "//www.bmc.com/content/dam/bmc/solutions/banners/tbn-dsm-mc-helix-service.png"}}'>
		<div class="offset-wrapper flex-center js-content-center-item">
			<div class="inner">
				<div class="bannerContent flex-center">
					<div class="layout-inner-wrap">
						<div class="flex-item col col-12 md-col-6 sm-col-8 no-top-bottom-margin">
						<h1 class="white">Corporate Leadership</h1>
						<h2>Meet the people who run and reinvent BMC<br>  ( Content -> Center & BG -> Center Top )</h2>
						</div>
					</div>
				</div>
			</div>
