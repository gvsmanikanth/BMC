<div class="navigation-secondary navigation-four-col layout-inner-wrap">
<ul >
		<li class="navigation-column">
			<ul>
				...
				<li class="navigation-section-header">Multi-Cloud</li>
				<li><a href="//www.bmc.com/it-solutions/cloud-cost-control.html"
					target="_self">Control Multi-Cloud Costs</a></li>
				<li><a
					href="//www.bmc.com/it-solutions/discovery-dependency-mapping.html"
		...
		<li class="navigation-column">
			<ul>
				<li class="navigation-section-header">AI & Machine Learning</li>
				<li><a
					href="//www.bmc.com/it-solutions/cognitive-service-management.html"
		...
		<li class="navigation-column navigation-column-emphasis navigation-column-image"  style="">
			<ul>
				<div class="nav-supplemental-with-images">
					<li><a href="http://marketplace.bmc.com"><img
							src="https://www.bmc.com/content/dam/bmc/images/Top-nav-multi-cloud.jpg"
							alt="BMC Marketplace"> </a></li>
				</div>
			</ul>
		</li>
