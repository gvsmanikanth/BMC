<?php
	...
	$bodyClass = 'page-campaign-landing bmc-nav-loader-nav form2 js-eh';
...
<div class="page-campaign-landing">    
    <div class="maincontentcontainer"> 
        <div class="wrapper1  js-ehItem">
            <section class="ornate-header"  style="background-color:#0091DD">
                <div class="header-banner">
                    <div class="layout-inner-wrap ">
                        <div class="md-flex ">
                            <div class="flex-item  md-col-6">
                                <div class="cmp-form form-wrapper">
                                    
                                </div>                        
                            </div>                   
                            <div class="flex-item  md-col-6 header-right">
            ...
            <div class="layout-inner-wrap page-content ">
                <div class="md-flex">
                        ...
                        <div class="aem-Grid ">
                            ...
                            <div class="htmlarea aem-GridColumn aem-GridColumn--default--12">
                                <div>
                                    ...
                                    <a href="google.com">100 rupaye</a>
                                </div>
                            </div>
                            <div class="htmlarea aem-GridColumn aem-GridColumn--default--12">
                                <div class="cust-info mb3 mt3">
                                    <div class="card ">
                                        ...
                                        <img class="circle" src="/content/dam/bmc/collateral/bmc/Placeholder-Man-img.jpg" alt="Robert Beauchamp" style="width:100%;max-width:300px;">
                                        </div>
                                        <div class="card-content">
                                        <p>After joining the company in 1988 as a sales executive, Beauchamp rose rapidly through the BMC ranks. During his tenure, he has led key business initiatives, including research and development, strategic marketing and corporate development. Named CEO in 2001,</p>
            ...
            <div class="md-flex  form-wrapp js-ehItem">
                <div class="flex-item md-col-6">
                    <form id="leadgen" name="leadgen" method="POST" action="/forms/contact-bmc/_jcr_content/root/responsivegrid/maincontentcontainer/_50_50contentcontain/right/form.post.html" enctype="multipart/form-data" 
                        ...
                        <div class="cmp cmp-title aem-GridColumn aem-GridColumn--default--12">
                            ...
                            <h6 class="form-validation-text">All fields are required for completion </h6>
                        </div>
        ...
        <section class="contact-info layout-inner-wrap ">
         <div class="sm-flex">
