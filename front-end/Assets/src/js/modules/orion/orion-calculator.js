	...
	function updateCalculator2(Calculator,componentID){
		...
		for(var y=0; y<calculator.environments.length; y++){
			...
			if(!thisEnv.deleted){
				...
				item += "<div class='totolExecutions flex-wrap ' style='overflow: visible;'><div class='flex-item col-12 md-col-7 lg-col-6'><div class='total'><div class='total-left'><p>Executions (including base "+thisEnv.baseEx+")</p><p><strong>"+thisQuantityFormatted+"</strong></p></div><div class='total-right'><p>Cost </p><p><strong>$"+thisPrice+"</strong></p> </div></div></div><div class='flex-item col-12 md-col-5 lg-col-6'><div class='infobox'><p>View additional transaction pricing</p><span class='orion_tooltip'> <span class='Tooltip-window'><table class='tooltip_table' style='width:100%'><tbody><tr><th>ADDITIONAL DAILY</th><th>PRICE</th></tr><tr><td>500</td><td>$9,100</td></tr><tr><td>1000</td><td>$14,650</td></tr><tr><td>2,000</td><td>$23,300</td></tr></tbody></table> </span> </span></div></div></div>";
