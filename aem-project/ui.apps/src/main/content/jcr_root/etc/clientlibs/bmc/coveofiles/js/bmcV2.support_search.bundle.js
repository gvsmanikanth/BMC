...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Coveo.$('#supprt-search-input,#supportSearchBox').coveo('initSearchbox',
    '/support/resources/support-search.html');
  ...
  Coveo.$('#supprt-search-input').find("input.CoveoQuerybox").attr("placeholder", 'Search BMC Support');
