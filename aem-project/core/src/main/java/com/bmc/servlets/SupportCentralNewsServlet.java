...
@SlingServlet(paths = "/bin/supportcentralnews", methods = { "GET" }) 
public class SupportCentralNewsServlet extends SlingSafeMethodsServlet {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory
			.getLogger(SupportCentralNewsServlet.class);
