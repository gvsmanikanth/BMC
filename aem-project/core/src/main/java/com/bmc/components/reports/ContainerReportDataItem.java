...
public class ContainerReportDataItem {
	...
	private String document_link_type;
	...
	public String getDocument_link_type() {
		return document_link_type;
	}
	public void setDocument_link_type(String document_link_type) {
		this.document_link_type = document_link_type;
	}
