...
public class JcrConsts {
    ...
    public static final String GATED_ASSET = "jcr:content/ic-app-inclusion";
    public static final String GATED_ASSET_FORM_PATH = "jcr:content/ic-app-form-path";
