 ...
 */
public class SupportCentralNavigationModel extends WCMUsePojo implements MultifieldDataProvider,UrlResolver {
	...
	private String templatePath = "/conf/bmc/settings/wcm/templates/support-central-personalised/structure/jcr:content/root/supportcentral_heade";
    @Override
