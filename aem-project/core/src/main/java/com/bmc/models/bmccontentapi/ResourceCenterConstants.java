...
public class ResourceCenterConstants {
    ...
    public static final String [] FILTERS_CUSTOM_LIST = new String[] {"ic-content-type","product_interest","ic-topics","ic-target-industry","ic-company-size","ic-target-persona","ic-buyer-stage","topics","credits-range","availibility","service-type"};
}